...
def normalized_row(
    ...
    return {
        ...
        **live,
        ...
        "request_throughput_rps": metric(result, "request_throughput"),
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--results-dir", type=Path, default=Path("results_a100"))
